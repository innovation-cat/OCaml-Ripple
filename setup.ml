...
(* OASIS_START *)
(* DO NOT EDIT (digest: ba4ce7ec25d32ec4429d69c4f201ec8b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors = ["Anbu Huang"];
          homepage = Some "https://github.com/wong4ever/OCaml-Ripple";
          synopsis =
            "Implement wave superposition with OCaml and GPU programming skill";
          description = None;
          categories = [];
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("VBO", None);
                           FindlibPackage ("png_loader", None);
                           InternalLibrary "FBO";
                           InternalLibrary "glex";
                           InternalLibrary "basic";
                           InternalLibrary "texture";
                           ...
                           InternalLibrary "field";
                           InternalLibrary "ripple"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\155D\166/ox\167\r\199\135\017@b`Em";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
